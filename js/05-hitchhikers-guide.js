let ready = prompt('Are you ready to play? Please enter yes or no.');
...
if (ready === 'yes') {
    ...
    let rating = parseInt(prompt('Game over - how would you rate it? (Please enter a number between 1 and 10'));

    if (isNaN(rating) || rating < 1 || rating > 10) {
        alert('Thank you for playing.');
    } else if(rating >= 6) {
        alert('Thank you for playing. Let\'s play again!');
    } else {
        alert('Thank you for playing. We are working hard to improve the game.');
    }

} else {
    alert('Thank you. Let\'s play again some time.');
}